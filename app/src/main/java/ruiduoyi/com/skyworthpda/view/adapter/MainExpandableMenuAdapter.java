...
public class MainExpandableMenuAdapter extends BaseExpandableListAdapter {
    ...
    public MainExpandableMenuAdapter(Context context, int childResources, int groupResources, List<String> groupTitles, List<List<String>> titles, List<List<Integer>> imgs) {
